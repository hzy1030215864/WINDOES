...
for iteration in range(max_iterations):
    ...
    for t in range(1, T):
        ...
        objective_expr += lambda_i1jt1[j, t] * (H_j0[j] + V_jt[j, t] + F_jt[j, t]-h_jt[j, t - 1] - O[j, t] )
        for i1 in range(I1):
    ...
    for j in range(J):
        for t in range(1, T):
            erlfa1[j, t] = h_value[j, t] + V_value[j, t]  - O_value[j, t] - h_value[j, t - 1]
            for i1 in range(I1):
    ...
    for j in range(J):
        for t in range(1, T):
            if erlfa1[j, t] == 0:
                ...
                sete[j, t] = (441334 - objective_value) / (erlfa1[j, t] * erlfa1[j, t])*0.2
                fm = erlfa1[j, t]
                lambda_i1jt1[j, t] += sete[j, t] * fm
                # lambda_i1jt1[j,t]=max(lambda_i1jt1[j,t],0)
